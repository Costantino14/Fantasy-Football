...
// Definisce lo schema per il modello SerieAPlayer23
const serieAPlayer23Schema = new mongoose.Schema({
  // ID univoco del giocatore, obbligatorio e unico
...
},
{
  ...
  collection: "serieaplayer23", // Nome specifico della collezione nel database MongoDB
});

// Crea e esporta il modello Mongoose 'SerieAPlayer23' basato sullo schema definito
export default mongoose.model('SerieAPlayer23', serieAPlayer23Schema);